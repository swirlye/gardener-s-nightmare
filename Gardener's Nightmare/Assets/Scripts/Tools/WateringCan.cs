...
public class WateringCan : MonoBehaviour
{
    ...
    private async Task TiltChecking()
    {
        while (_waterFull && _checkTilt)
        {
            ...
            float angleTowards = -(180 - MoveScissorHand.SignedAngleBetween(_TransformReference.forward, _Nozzle.forward, _Nozzle.right, true)); // this is weird but... works fair enough for now
